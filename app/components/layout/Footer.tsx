...
import { ChevronDownIcon, SubscripbeArrowIcon } from "~/images/Icons";
    ...
    <footer className="footer-section">
      <div className="section-inner">
        ...
        <div className="newsletter-wrapper">
          ...
          <span className="footer-content">Subscribe our Newsletter</span>
          <div className="newsletter-form-wrapper">
            <form className="footer_newsletter form">
              <div className="input-button-wrapper">
                ...
                />
                <button className="form_submit Button Button--primary" type="submit" aria-label="newsletter-submit">
                    <SubscripbeArrowIcon />
                </button>
              </div>
            </form>
        ...
        <div className="footer-bottom-wrapper">
          <div className="left-content">
            <div className="left-inner">
              ...
              <div className="footer-link-wrapper">
                <h4 className="block-title">Company</h4>
          ...
          <div className="right-content xs-hide">
        ...
        <div className="footer-bootom-section">
          ...
          <div className="left-content">
            <div
              ref={dropdownRef}
              className="most-search-keyword-title dropdown-toggle-js"
            >
              <div className="most-search-wrapper">
                <span className="text">Most Searched</span>
              ...
              <div className="most-serched-link-inner">
          ...
          <div className="right-content">
            <div className="download-app-text-wrapper">
              <a
        ...
        <div className="bootom-copyright-section">
          <p className="help-center-text">
            All Rights Reserved TheHouseOfRare &copy; {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </footer>
...
function SocialIcon({
  ...
  return (
    <a
      ...
      className="social-icon social-icon-js"
    >
      {children}
    </a>
  );
