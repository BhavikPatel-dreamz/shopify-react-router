// components/RareismSummerTaleImages.tsx
...
interface RareismSummerTaleImagesProps {
  items: ImageItem[];
  sectionId: string;
  paddingClass: string;
}

const RareismSummerTaleImages: React.FC<RareismSummerTaleImagesProps> = ({ 
  items, 
  sectionId, 
  paddingClass 
}) => {
...
export default RareismSummerTaleImages;