// app/components/homePages/FootwearThroughTheYearsImages.tsx
...
interface FootwearThroughTheYearsImagesProps {
  items: ImageItem[];
  sectionId: string;
  paddingClass: string;
}

const FootwearThroughTheYearsImages: React.FC<FootwearThroughTheYearsImagesProps> = ({ 
  items, 
  sectionId, 
  paddingClass 
}) => {
...
export default FootwearThroughTheYearsImages;