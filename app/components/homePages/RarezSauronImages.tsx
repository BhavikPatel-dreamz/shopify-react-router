// app/components/homePages/RarezSauronImages.tsx
...
interface RarezSauronImagesProps {
  items: ImageItem[];
  sectionId: string;
  paddingClass: string;
}

const RarezSauronImages: React.FC<RarezSauronImagesProps> = ({ 
  items, 
  sectionId, 
  paddingClass 
}) => {
...
export default RarezSauronImages;