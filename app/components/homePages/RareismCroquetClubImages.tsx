// components/RareismCroquetClubImages.tsx
...
interface RareismCroquetClubImagesProps {
  items: ImageItem[];
  sectionId: string;
  paddingClass: string;
}

const RareismCroquetClubImages: React.FC<RareismCroquetClubImagesProps> = ({ 
  items, 
  sectionId, 
  paddingClass 
}) => {
...
export default RareismCroquetClubImages;