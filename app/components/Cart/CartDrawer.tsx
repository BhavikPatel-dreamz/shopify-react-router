...
export default function CartDrawer({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <>
      ...
      <div className={`cart-drawer-section ${isActive ? "active" : ""} ${isCartEmpty ? "cart-is-empty" : ""}`} data-cart_count={items.length}>
        <div className="section-inner">
          <div className="cart-drawer">
            <CartHeader itemCount={items.length} onClose={handleClose} />

            {/* GWP Section - Hide when cart is empty */}
            {!isCartEmpty && (
              <>
            ...
            {/* Cart Items - Conditional based on cart empty */}
            <div className="cart-drawer-inner" style={{ height: isCartEmpty ? "calc(100% - 86px)" : "calc(100% - 339px)" }}>
              {isCartEmpty ? (
                <EmptyCart />
              ) : (
                <>
            ...
            {/* Bottom Section - Hide when cart is empty */}
            {!isCartEmpty && (
